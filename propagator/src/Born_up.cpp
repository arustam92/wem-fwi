...
Born_up::Born_up(std::shared_ptr<complex2DReg> slow, std::shared_ptr<paramObj> par,
...
void Born_up::forward(std::shared_ptr<complex2DReg> model, std::shared_ptr<complex3DReg> data, bool add) {
...
void Born_up::adjoint(std::shared_ptr<complex2DReg> model, std::shared_ptr<complex3DReg> data, bool add) {
